...
class MetricAlphaCLIPScore:
    ...
    def evaluate(self, generated_image: Image.Image, mask: Image.Image, prompt: str):
        """
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--threshold", type=float, help="Threshold for filtering images"
    )
    parser.add_argument("--images_dir_path", type=str, help="Path to augmented images")
    parser.add_argument("--masks_dir_path", type=str, help="Path to masks")
    parser.add_argument("--texts_dir_path", type=str, help="Path to text prompts")
    parser.add_argument("--weights", type=str, help="Path to text prompts")
